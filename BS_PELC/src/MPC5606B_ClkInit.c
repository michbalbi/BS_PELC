...
#define PCTL_DSPI_0			4
#define PCTL_DSPI_1			5
#define PCTL_DSPI_2			6
#define PCTL_FLEXCAN_0		16
#define PCTL_FLEXCAN_1		17
#define PCTL_FLEXCAN_2		18
#define PCTL_FLEXCAN_3		19
#define PCTL_FLEXCAN_4		20
#define PCTL_FLEXCAN_5		21
...
void initModesAndClock(void) {
  ...
  ME.PCTL[PCTL_EMIOS_0].R = 0x01u;
  ME.PCTL[PCTL_ADC_0].R = 0x01u;
  ME.PCTL[PCTL_FLEXCAN_0].R = 0x01u;
  ME.PCTL[PCTL_FLEXCAN_1].R = 0x01u;
  ME.PCTL[PCTL_FLEXCAN_2].R = 0x01u;
  ME.PCTL[PCTL_DSPI_0].R = 0x01u;
  ME.PCTL[PCTL_DSPI_1].R = 0x01u;
  ME.PCTL[PCTL_DSPI_2].R = 0x01u;
...
/* Use the following code as required for MPC56xxB or MPC56xxS:*/
  CGM.SC_DC[PS2_DIV].R = 0x80u;   /* MPC56xxB/S: Enable peri set 1 sysclk divided by 1 */
  CGM.SC_DC[PS3_DIV].R = 0x80u;
}
